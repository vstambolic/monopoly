...
public abstract class Field {
    ...
    static {
        ...
        fields[2] = new NoActionField("Start","x x x x $522 xx!"); // TODO
        ...
        fields[5] = new NoActionField("Start","x x x x $522 xx!"); // TODO
        fields[6] = new PropertyField("ORIENTAL AVENUE",1,3,100,6,15,new int[]{30,90,270,400},550,50,100);
        fields[7] = new NoActionField("Start","x x x x $522 xx!"); // TODO
